...
class Employee {
    ...
    getSchedule(){
        console.log(`${this.name} works on the following shifts: ${this.shifts}`)
    }
...
let empOne = new Employee("Marko", "weekday nights, Saturday night, Sunday all day, weekday days, Saturday day")
...
let manager = new Manager("Overwatch Winston", "weekday mornings, weekday afternoons", ["Cece", "Schmidt"])
